...
**[agent]** `examine "mysterious message"`

**[environment]** You don't see ""mysterious message"" here or in your inventory.

**[agent]** `examine wooden door`

**[environment]** You don't see "wooden door" here or in your inventory.
